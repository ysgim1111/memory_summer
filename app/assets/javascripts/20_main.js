...
/*application js add */
	function initMain_sign(){
		//do whatever it is present
		//sign_up
		$("#sign_up").hide();
      $("#in_go").click(function () {
        $("#sign_up").hide();
        $("#sign_in").show();
      });
    ...
    $('figure').css('cursor','pointer');
	   $('.col-xs-6').css('cursor','pointer');
	   $('.main_services').on('click',function(){
	     $(this).each(function(){
	       var link = $(this).find('a').attr('href');
	       window.location.href = link;
	     })
	   })
	   $('.col-xs-6').on('click',function(){
	     $(this).each(function(){
	       var link = $(this).find('a').attr('href');
	       window.location.href = link;
	     })
		...
		if (hasCounters) {
			...
			var waypoint = new Waypoint({
			  ...
			  handler: function() {
					...
					// Counter 1
					var counter1 = new CountUp('count-1', current_status + 490, current_status + 520, 0, 5, options);
					counter1.start();
					// Counter 2
